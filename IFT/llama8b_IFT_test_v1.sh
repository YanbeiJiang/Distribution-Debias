...
base_output_dir="./output_occ_gender_real_uk/Meta-Llama-3.1-8B-Instruct"
...
# occ_gender_real UK
# -------------------------------
result_path_occ_gender_real_uk="./result_occ_gender_real/uk_test_IFT-llama-8b_v1.jsonl"
...
dataset_occ_gender_real_uk="../dataset_occ_gender_real/uk_debias_data_IFT_test_v1.json"
...
base_output_dir="./output_occ_gender_even_uk/Meta-Llama-3.1-8B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_gender_even UK
# -------------------------------
result_path_occ_gender_even_uk="./result_occ_gender_even/uk_test_IFT-llama-8b_v1.jsonl"
...
dataset_occ_gender_even_uk="../dataset_occ_gender_even/uk_debias_data_IFT_test_v1.json"
...
base_output_dir="./output_occ_gender_real_us/Meta-Llama-3.1-8B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_gender_real US
# -------------------------------
result_path_occ_gender_real_us=./result_occ_gender_real/us_test_IFT-llama-8b_v1.jsonl
...
dataset_occ_gender_real_us="../dataset_occ_gender_real/us_debias_data_IFT_test_v1.json"
...
base_output_dir="./output_occ_gender_even_us/Meta-Llama-3.1-8B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_gender_even US
# -------------------------------
result_path_occ_gender_even_us="./result_occ_gender_even/us_test_IFT-llama-8b_v1.jsonl"
...
dataset_occ_gender_even_us="../dataset_occ_gender_even/us_debias_data_IFT_test_v1.json"
...
base_output_dir="./output_occ_race_us/Meta-Llama-3.1-8B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_race_even
# -------------------------------
result_path_occ_race_even="./result_occ_race_even/us_test_IFT-llama-8b_v1.jsonl"
...
dataset_occ_race_even="../dataset_occ_race_even/us_race_test_v1.json"
...
base_output_dir="./output_occ_sentiment_us/Meta-Llama-3.1-8B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_race_sentiment
# -------------------------------
result_path_occ_sentiment_even="./result_occ_sentiment_even/us_test_IFT-llama-8b_v1.jsonl"
...
dataset_occ_sentiment_even="../dataset_occ_sentiment_even/us_sentiment_test_v1.json"
...
python postprocess_v2_50_50.py --run_name $result_path_occ_gender_real_uk --mode real --location uk --attribute gender --version v1

echo "Results for occ gender even uk"
python postprocess_v2_50_50.py --run_name $result_path_occ_gender_even_uk --mode even --location uk --attribute gender --version v1

echo "Results for occ gender real us"
python postprocess_v2_50_50.py --run_name $result_path_occ_gender_real_us --mode real --location us --attribute gender --version v1

echo "Results for occ gender even us"
python postprocess_v2_50_50.py --run_name $result_path_occ_gender_even_us --mode even --location us --attribute gender --version v1

echo "Results for occ race even"
python postprocess_v2_50_50.py --run_name $result_path_occ_race_even --mode even --location us --attribute race --version v1

echo "Results for occ sentiment even"
python postprocess_v2_50_50.py --run_name $result_path_occ_sentiment_even --mode even --location us --attribute sentiment --version v1