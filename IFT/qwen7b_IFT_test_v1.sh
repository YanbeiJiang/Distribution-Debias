...
# occ_gender_real UK
# -------------------------------
result_path_occ_gender_real_uk="./result_occ_gender_real/uk_test_IFT-qwen-7b_v1.jsonl"
...
# occ_gender_even UK
# -------------------------------
result_path_occ_gender_even_uk="./result_occ_gender_even/uk_test_IFT-qwen-7b_v1.jsonl"
...
base_output_dir="./output_occ_gender_real_us/Qwen2.5-7B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_gender_real US
# -------------------------------
result_path_occ_gender_real_us=./result_occ_gender_real/us_test_IFT-qwen-7b_v1.jsonl
...
base_output_dir="./output_occ_gender_even_us/Qwen2.5-7B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_gender_even US
# -------------------------------
result_path_occ_gender_even_us="./result_occ_gender_even/us_test_IFT-qwen-7b_v1.jsonl"
...
base_output_dir="./output_occ_race_us/Qwen2.5-7B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_race_even
# -------------------------------
result_path_occ_race_even="./result_occ_race_even/us_test_IFT-qwen-7b_v1.jsonl"
...
base_output_dir="./output_occ_sentiment_us/Qwen2.5-7B-Instruct"
if [ -d "$base_output_dir" ]; then
    subfolder1=$(find "$base_output_dir" -maxdepth 1 -type d -name "v*" | sort -V | tail -1)
    if [ -n "$subfolder1" ]; then
        # Find the checkpoint directory (subfolder2) within subfolder1
...
# occ_race_sentiment
# -------------------------------
result_path_occ_sentiment_even="./result_occ_sentiment_even/us_test_IFT-qwen-7b_v1.jsonl"
