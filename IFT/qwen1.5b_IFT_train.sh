...
swift sft \
    ...
    --logging_steps 5 \
    --max_length 2048 \
    --output_dir output_occ_gender_real_uk/Qwen2.5-1.5B-Instruct \
    --warmup_ratio 0.05 \
    --use_hf true \
...
swift sft \
    ...
    --logging_steps 5 \
    --max_length 2048 \
    --output_dir output_occ_gender_even_uk/Qwen2.5-1.5B-Instruct \
    --warmup_ratio 0.05 \
    --use_hf true \
...
swift sft \
    ...
    --logging_steps 5 \
    --max_length 2048 \
    --output_dir output_occ_gender_real_us/Qwen2.5-1.5B-Instruct \
    --warmup_ratio 0.05 \
    --use_hf true \
...
swift sft \
    ...
    --logging_steps 5 \
    --max_length 2048 \
    --output_dir output_occ_gender_even_us/Qwen2.5-1.5B-Instruct \
    --warmup_ratio 0.05 \
    --use_hf true \
...
swift sft \
    ...
    --logging_steps 5 \
    --max_length 2048 \
    --output_dir output_occ_race_us/Qwen2.5-1.5B-Instruct \
    --warmup_ratio 0.05 \
    --use_hf true \
...
swift sft \
    ...
    --logging_steps 5 \
    --max_length 2048 \
    --output_dir output_occ_sentiment_us/Qwen2.5-1.5B-Instruct \
    --warmup_ratio 0.05 \
    --use_hf true \