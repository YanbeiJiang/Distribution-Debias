...
# occ_gender_real UK
# -------------------------------
result_path_occ_gender_real_uk="./result_occ_gender_real/uk_test_IFT-llama-8b_v2_ood.jsonl"
...
# occ_gender_even UK
# -------------------------------
result_path_occ_gender_even_uk="./result_occ_gender_even/uk_test_IFT-llama-8b_v2_ood.jsonl"
